...
class Model(nn.Module):
    def __init__(self, args):
        ...
        self.Transformer = Van_Transformer(args.layers, args.channel, args.d_hid, length=args.frames,model_sel=args.model_selc)
        self.Transformer_reduce = Stride_Transformer(len(args.stride_num), args.channel, args.d_hid,
            length=args.frames, stride_num=args.stride_num,model_sel=args.model_selc)
